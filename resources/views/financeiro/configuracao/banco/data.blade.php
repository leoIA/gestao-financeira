...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">BANCO</span>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            ...
            <form id="formUsuario" method="post" action="/financeiro/banco/salvar" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Número</label>
                                    <input type="text" name="numero" maxlength="5" value="<?php print $return_numero; ?>" class="form-control" required>
                                </div>
                            </div>
                        </div>
