        ...
        <div class="col-lg-12">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div class="left-content">
                            <span class="main-content-title mg-b-0 mg-b-lg-1">Listagem de Categorias</span>
                        </div>
                        <div class="right-content">
                            <a href="/financeiro/categoria/novo" class="btn btn-success btn-sm d-lg-block m-l-15 text-white"><i class="fa fa-plus-circle"></i> Nova Categoria</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href='/financeiro/categoria/editar/{{ $resultado_item->id }}' class="btn btn-sm btn-info disabled"><i class="far fa-edit"></i> Editar</a>
