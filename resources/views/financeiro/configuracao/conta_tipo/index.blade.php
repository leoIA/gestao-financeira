...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">TIPOS DE CONTA</span>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="breadcrumb-header justify-content-between">
                        ...
                        <div class="right-content">
                            <a href="/financeiro/conta-tipo/novo" class="btn btn-success btn-sm d-lg-block m-l-15 text-white"><i class="fa fa-plus-circle"></i> Novo Tipo de Conta</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href='/financeiro/conta-tipo/editar/{{ $resultado_item->id }}' class="btn btn-sm btn-info disabled"><i class="far fa-edit"></i> Editar</a>
