...
if(isset($data)):
    ...
    $return_tipo_lancamento = $data->tipo_lancamento;
    $return_ativo = $data->ativo;
else:
    $return_id = '';
    $return_descricao = '';
    $return_plano_contas_id = '';
    $return_tipo_lancamento = '';
    $return_ativo = '1';
endif;
?>
...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">PLANO DE CONTA</span>
        </div>
    </div>
    <!-- /breadcrumb -->
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                ...
                <div class="card-body pt-0">
                    ...
                    <form id="formUsuario" method="post" action="/financeiro/plano-de-contas/salvar" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php print $return_id; ?>">
                        <input type="hidden" name="tipo_lancamento" value="<?php print $tipo_lancamento; ?>">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="plano_contas_id" id="plano_contas_id" class="form-control">
