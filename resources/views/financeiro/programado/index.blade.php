...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">PROGRAMAÇÃO</span>
        </div>
    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <h3 class="display-6 font-weight-bold text-dark mb-2" style="letter-spacing: -1px;">
                                Pare de lutar contra o <span class="text-primary">Calendário</span>
                            </h3>
                            <p class="lead text-muted mb-4" style="font-size: 1.1rem; line-height: 1.6;">
                                O módulo de <strong>Contas Programadas e Recorrência</strong> permite que você automatize seu fluxo de caixa para os próximos meses. 
                                Evite multas por esquecimento e tenha uma projeção financeira fiel sem trabalho manual repetitivo.
                            </p>
                            <div class="d-flex flex-wrap" style="gap: 5px;">
                                <span class="badge badge-pill badge-primary-transparent py-2 px-3 mb-2">
                                    🤖 Automação de Despesas Fixas
                                </span>
                                <span class="badge badge-pill badge-primary-transparent py-2 px-3 mb-2">
                        ...
                        <div class="col-lg-4 text-center mt-4 mt-lg-0">
                            <a href="https://wa.me/{{$whats_numero}}?text=Olá! Gostaria de contratar a implementação do módulo de Programação de Contas e Recorrência na minha plataforma iLAB4." 
                               target="_blank" 
